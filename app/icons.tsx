...
export function LinkCard({
  ...
  return (
    <a
      ...
      className="flex items-center p-1 w-full rounded-lg hover:scale-105 transition-all bg-gray-100 mb-3 max-w-3xl"
    >
      <div className="flex text-center w-full p-3">
        <h2 className="flex justify-center items-center font-semibold w-full text-xl lg:text-2xl xl:text-2xl text-gray-700 text-center">
          {title}
        </h2>
      </div>
    </a>
